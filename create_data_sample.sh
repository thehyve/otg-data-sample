...
echo "[$(time_stamp)] Filtering genes index (1/11)"
...
echo "[$(time_stamp)] Filtering variant index (2/11)"
...
echo "[$(time_stamp)] Filtering study index (3/11)"
...
echo "[$(time_stamp)] Filtering study overlap index (4/11)"
...
echo "[$(time_stamp)] Filtering variant to disease colocation records (8/11)"
...
echo "[$(time_stamp)] Filtering variant to disease credset records (9/11)"
...
echo "[$(time_stamp)] Filtering gwas records (10/11)"
...
echo "[$(time_stamp)] Filtering molecular trait records (11/11)"
